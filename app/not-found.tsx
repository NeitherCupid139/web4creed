...
function ExampleContent() {
  return (
    <div className="relative grid h-screen place-content-center space-y-6 bg-neutral-950 p-8">
      <p className="text-center text-6xl font-black text-neutral-50">404</p>
      <p className="text-center text-neutral-400">回到过去 📺</p>
...
export default function FuzzyOverlayExample() {
  return (
